...
\BLOCK{for project in projects}
    ...
    % --- Metadata: Timeline, Technologies ---
    \small\textit{\color{MetaColor}
        \BLOCK{if project.portfolio_details.timeline}
            \textbf{Timeline:} \VAR{project.portfolio_details.timeline | escape_latex}
        \BLOCK{endif}
        \BLOCK{if project.portfolio_details.technologies}
            \hfill \textbf{Technologies:} \VAR{project.portfolio_details.technologies | escape_latex}
        \BLOCK{endif}
    }
    \vspace{6pt}
