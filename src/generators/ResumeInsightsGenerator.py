...
class ResumeInsightsGenerator:
   """
   Generates resume bullet points and summaries using normalized category counts
   provided by FileCategorizer (via ProjectMetadataExtractor)
   ...
   def __init__(self, metadata, categorized_files, language_share, project, language_list):
       ...
       self.verbs = [
           ...
           "Designed", "Built", "Contributed to", "Enhanced"
       ]
